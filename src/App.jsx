...
function Home() {
  return (
    <div className="min-h-screen bg-white">
      <section className="bg-[#E63900] text-white py-20 text-center relative overflow-hidden">
        <img src="https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=1200" className="absolute inset-0 w-full h-full object-cover opacity-30" />
